...
int main() {
    ...
    // this is a vector of vectors such that outer vector forms the rows of the matrix and the inner vector forms the columns which are all initialized to 0;
    // outer vector has been initialized with rows... inner vector for columns...
